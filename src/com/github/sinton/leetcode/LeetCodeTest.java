...
public class LeetCodeTest {
    ...
    public void rob() {
        ...
        for (int[] caseItem : testCase) {
            System.out.println(solution500.rob(caseItem));
        }
    }
    ...
    public void evalRPN() {
        ...
        for (String[] caseItem : testCase) {
            System.out.println(solution500.evalRPN(caseItem));
        }
    }
    ...
    public void findTheDifference() {
        ...
        for (String[] caseItem : testCase) {
            System.out.println(solution500.findTheDifference(caseItem[0], caseItem[1]));
        }
    }
    ...
    public void moveZeroes() {
        ...
        for (int[] caseItem : testCase) {
            solution500.moveZeroes(caseItem);
...
//            },
    ...
    public void solutionClimbStairs() {
        int[] testCase = {2, 3, 45};
        for (int caseItem : testCase) {
            System.out.println(solution500.climbStairs(caseItem));
        }
    }
    ...
    public void solutionFindKthLargest() {
        ...
        for (int[][] caseItem : testCase) {
            System.out.println(solution500.findKthLargest(caseItem[0], caseItem[1][0]));
        }
    }
    ...
    public void solutionLengthOfLongestSubstring() {
        ...
        for (String caseItem : testCase) {
            System.out.println(solution500.lengthOfLongestSubstring(caseItem));
        }
    }
...
//            }
        ...
        for (int[][] caseItem : testCase) {
            int[][] result = solution500.merge(caseItem);
            for(int[] item : result) {
    ...
    public void generate() {
        int[] testCase = {5, 1};
        for (int caseItem : testCase) {
            System.out.println(solution500.generate(caseItem).toString());
        }
    }
    ...
    public void solutionLongestPalindrome() {
        ...
        for (String caseItem : testCase) {
            System.out.println(solution500.longestPalindrome(caseItem));
        }
    }
    ...
    public void isValid() {
        ...
        for (String caseItem : testCase) {
            System.out.println(solution500.isValid(caseItem));
        }
    }
    ...
    public void removeElements() {
        ...
        for (int[][] caseItem : testCase) {
            Helper.listNodeFormatOutput(solution500.removeElements(Helper.buildListNode(caseItem[0]), caseItem[1][0]));
        }
    }
    ...
    public void deleteDuplicates() {
        ...
        for (int[] caseItem : testCase) {
            Helper.listNodeFormatOutput(solution500.deleteDuplicates(Helper.buildListNode(caseItem)));
        }
    }
...
//            {1, 2, 3, 4, 5, 6},
        ...
        for (Integer[] caseItem : testCase) {
            ...
            root4.left = root3;
            root4.right = root2;
            System.out.println(solution500.maxDepth(root4));
        }
    }
    ...
    public void canConstruct() {
        ...
        for (String[] caseItem : testCase) {
            System.out.println(solution500.canConstruct(caseItem[0], caseItem[1]));
        }
    }
    ...
    public void isAnagram() {
        ...
        for (String[] caseItem : testCase) {
            System.out.println(solution500.isAnagram(caseItem[0], caseItem[1]));
        }
    }
    ...
    public void firstUniqChar() {
        ...
        for (String caseItem : testCase) {
            System.out.println(solution500.firstUniqChar(caseItem));
        }
    }
...
//            {1, 2, 3, 4, 5, 6},
    ...
    public void solutionMergeTwoLists() {
        ...
        for (int[][] caseItem : testCase) {
            ...
            Helper.listNodeFormatOutput(solution500.mergeTwoLists(left, right));
        }
    }
    ...
    public void divide() {
        ...
        for (int[] caseItem : testCase) {
            System.out.println(solution500.divide(caseItem[0], caseItem[1]));
        }
    }
    ...
    public void reverseList() {
        ...
        for (int[] caseItem : testCase) {
            ListNode head = Helper.buildListNode(caseItem);
            Helper.listNodeFormatOutput(solution500.reverseList(head));
        }
    }
    ...
    public void intersection() {
        ...
        for (int[][] caseItem : testCase) {
            System.out.println(Arrays.toString(solution500.intersect(caseItem[0], caseItem[1])));
        }
    }
    ...
    public void solutionMaxProfit() {
        ...
        for (int[] caseItem : testCase) {
            System.out.println(solution500.maxProfit(caseItem));
        }
    }
    ...
    public void solutionIsPalindrome() {
        ...
        for (int caseItem : testCase) {
            System.out.println(solution500.isPalindrome(caseItem));
        }
    }
    ...
    public void solutionTwoSum() {
        ...
        for (int[][] caseItem : testCase) {
            System.out.println(Arrays.toString(solution500.twoSum(caseItem[0], caseItem[1][0])));
        }
    }
    ...
    public void solutionMerge88() {
        ...
        for (int[][] caseItem : testCase) {
            solution500.merge(caseItem[0], caseItem[1][0], caseItem[2], caseItem[3][0]);
    ...
    public void solutionIsIsomorphic() {
        ...
        for (String[] caseItem : testCase) {
            System.out.println(solution500.isIsomorphic(caseItem[0], caseItem[1]));
        }
    }
    ...
    public void solutionIsSubsequence() {
        ...
        for (String[] caseItem : testCase) {
            System.out.println(solution500.isSubsequence(caseItem[0], caseItem[1]));
        }
    }
    ...
    public void solutionContainsDuplicate() {
        ...
        for (int[] caseItem : testCase) {
            System.out.println(solution500.containsDuplicate(caseItem));
        }
    }
    ...
    public void solutionMaxSubArray() {
        ...
        for (int[] caseItem : testCase) {
            System.out.println(solution500.maxSubArray(caseItem));
        }
    }
    ...
    public void nextGreaterElement() {
        ...
        for (int[][] caseItem : testCase) {
            System.out.println(Arrays.toString(solution500.nextGreaterElement(caseItem[0], caseItem[1])));
        }
    }
    ...
    public void getHint() {
        ...
        for (String[] caseItem : testCase) {
            System.out.println(solution500.getHint(caseItem[0], caseItem[1]));
        }
    }
    ...
    public void decodeString() {
        ...
        for (String caseItem : testCase) {
            System.out.println(solution500.decodeString(caseItem));
        }
    }
    ...
    public void searchMatrix() {
        ...
        for (int[][][] caseItem : testCase) {
            System.out.println(solution500.searchMatrix(caseItem[0], caseItem[1][0][0]));
        }
    }
    ...
    public void preorderTraversal() {
        ...
        System.out.println(solution500.preorderTraversal(root3));

        TreeNode root = new TreeNode(1);
        root.right = new TreeNode(3);
        root.right.left = new TreeNode(2);
        System.out.println(solution500.preorderTraversal(root));
        ...
        System.out.println(solution500.preorderTraversal(root1));
        ...
        System.out.println(solution500.preorderTraversal(root2));

        System.out.println(solution500.preorderTraversal(null));
        System.out.println(solution500.preorderTraversal(new TreeNode(1)));
    }
    ...
    public void inorderTraversal() {
        ...
        root3.right = new TreeNode(2);
        root3.right.left = new TreeNode(3);
        System.out.println(solution500.inorderTraversal(root3));

        TreeNode root = new TreeNode(1);
        root.right = new TreeNode(3);
        root.right.left = new TreeNode(2);
        System.out.println(solution500.inorderTraversal(root));
        ...
        root1.right.left = new TreeNode(3);
        root1.right.right = new TreeNode(6);
        System.out.println(solution500.inorderTraversal(root1));
        ...
        root2.left.left = new TreeNode(3);
        root2.left.right = new TreeNode(6);
        System.out.println(solution500.inorderTraversal(root2));

        System.out.println(solution500.inorderTraversal(null));
        System.out.println(solution500.inorderTraversal(new TreeNode(1)));
    }
    ...
    public void postorderTraversal() {
        ...
        root3.right = new TreeNode(2);
        root3.right.left = new TreeNode(3);
        System.out.println(solution500.postorderTraversal(root3));

        TreeNode root = new TreeNode(1);
        root.right = new TreeNode(3);
        root.right.left = new TreeNode(2);
        System.out.println(solution500.postorderTraversal(root));
        ...
        root1.right.left = new TreeNode(3);
        root1.right.right = new TreeNode(6);
        System.out.println(solution500.postorderTraversal(root1));
        ...
        root2.left.left = new TreeNode(3);
        root2.left.right = new TreeNode(6);
        System.out.println(solution500.postorderTraversal(root2));

        System.out.println(solution500.postorderTraversal(null));
        System.out.println(solution500.postorderTraversal(new TreeNode(1)));
    }
    ...
    public void isValidBST() {
        ...
        root.right = new TreeNode(3);
        System.out.println(solution500.isValidBST(root));
        ...
        root1.right.left = new TreeNode(3);
        root1.right.right = new TreeNode(6);
        System.out.println(solution500.isValidBST(root1));
        ...
        System.out.println(solution500.isValidBST(root2));
        ...
        System.out.println(solution500.isValidBST(root3));
    }
    ...
    public void hasPathSum() {
        ...
        System.out.println(solution500.hasPathSum(root, 22));

        TreeNode root1 = new TreeNode(1);
        root1.left = new TreeNode(2);
        root1.right = new TreeNode(3);
        System.out.println(solution500.hasPathSum(root1, 5));

        System.out.println(solution500.hasPathSum(null, 0));
    }
    ...
    public void sumOfLeftLeaves() {
        ...
        System.out.println(solution500.sumOfLeftLeaves(root1));
        System.out.println(solution500.sumOfLeftLeaves(new TreeNode(1)));
    }
    ...
    public void lowestCommonAncestor() {
        ...
        TreeNode answer = solution500.lowestCommonAncestor(root, new TreeNode(2), new TreeNode(4));
...
//        System.out.println(root);
    ...
    public void invertTree() {
        ...
        root.right.right = new TreeNode(9);
        root = solution500.invertTree(root);
        System.out.println(root);
    }
